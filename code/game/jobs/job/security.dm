...
/datum/job/hos/equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/secmask(H), slot_in_backpack)
...
/datum/job/warden
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "the sectoral commander"
...
/*	if (H.mind.role_alt_title)
		...
		if("RCT of Ground Unit")
		     H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security(H), slot_w_uniform)
	         H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
	         H.equip_to_slot_or_del(new /obj/item/weapon/handcuffs(H), slot_s_store)
	         H.equip_to_slot_or_del(new /obj/item/device/flash(H), slot_l_store)
	         H.equip_to_slot_or_del(new /obj/item/weapon/stunbaton(H.back), slot_in_backpack)*/
